...
export default function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-start p-4 bg-background text-foreground overflow-hidden pt-24">
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center space-y-12">
        <ClockDisplay />
